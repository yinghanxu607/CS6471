...
global VMAX Map_Data Finish_Data Pos_Vector_Indexes Speed_Vector_Indexes  st_len policy
...
tic
[Q, V2, policy, mean_discrepancy] = mdp_Q_learning(P2, C2, 0.99);
toc
plot(mean_discrepancy)
xlabel('iteration time / 10')
ylabel('mean discrepancy')
